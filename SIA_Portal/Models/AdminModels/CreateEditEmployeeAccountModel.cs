...
{
    public class CreateEditEmployeeAccountModel : BaseAccountLoggedInModel
    {
        ...
        //
        public string InputChosenEmployeeCategory { set; get; }

        public IList<string> ListOfEmployeeCategories { set; get; }
        ...
        //
        public CreateEditEmployeeAccountModel() : base() { }

        public CreateEditEmployeeAccountModel(object account) : base((Account) account) { }
